...
export const FALLBACK_NEWS = [
  {
    id: 'gta-vi-release-date-status',
    title: 'GTA VI Release Date: Confirmed Details and Platform Status',
    author: 'Leonida Loot',
    source: 'Leonida Loot',
    type: 'Guide',
    publishedAt: '2026-07-07T00:00:00.000Z',
    summary: 'Track the November 19, 2026 GTA VI launch date, confirmed console platforms, and the details that remain unconfirmed.',
    url: '/guides/gta-vi-release-date',
  },
  {
    id: 'gta-vi-map-leonida-guide',
    title: 'GTA VI Map and Leonida Guide',
    author: 'Leonida Loot',
    source: 'Leonida Loot',
    type: 'Guide',
    publishedAt: '2026-07-07T00:00:00.000Z',
    summary: 'Explore Vice City, Leonida regions, wetlands, Keys-like islands, trailer location clues, and source-linked map context.',
    url: '/guides/gta-vi-map-and-leonida',
  },
  {
    id: 'gta-vi-characters-lucia-jason',
    title: 'GTA VI Characters: Lucia, Jason and Confirmed Cast',
    author: 'Leonida Loot',
    source: 'Leonida Loot',
    type: 'Guide',
    publishedAt: '2026-07-07T00:00:00.000Z',
    summary: 'Meet Lucia Caminos, Jason Duval, and the supporting characters visible in public GTA VI material.',
    url: '/guides/gta-vi-characters-lucia-jason',
  },
  {
    id: 'ign-gta-vi-page',
    title: 'Grand Theft Auto VI Coverage on IGN',
    author: 'IGN',
    source: 'IGN',
    type: 'Source',
    publishedAt: '',
    summary: 'Open IGN coverage for additional Grand Theft Auto VI news, videos, previews, and updates.',
    url: IGN_GAME_URL,
  },
]
